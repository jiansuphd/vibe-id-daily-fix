...
```bash
gemini "Generate a zero-draft for Module 5. It should contain all required content but not be polished. I will edit. Mark every section you are uncertain about with [VERIFY]."
```
...
- [Source Daily](../10_dailies/day-85-the-zero-draft-strategy.md)
