...
*   [x] **Skill Library**: Built out `00_Meta/skills/` with SOPs: `AltText_Reviewer.md`, `Syllabus_Migration.md`, `Bloom_Taxonomy_Aligner.md`, `Synthetic_Student_Simulator.md`.
*   [ ] **Skill Library Expansion**: Add further specialized ID workflows (e.g., Prompt Injection Auditing).
