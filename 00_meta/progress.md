...
- Removed "Senior ID" - changed to "Senior ID". Cleaned personal and institution refs from Manifesto section. Updated folder descriptions to reflect current build artifact pipeline.
