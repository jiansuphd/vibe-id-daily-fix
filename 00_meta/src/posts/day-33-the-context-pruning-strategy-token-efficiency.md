...
- **The Details:** As conversations get long, "token noise" increases. Pruning keeps the AI focused on the core logic of your current current course build without the baggage of older, resolved issues.
